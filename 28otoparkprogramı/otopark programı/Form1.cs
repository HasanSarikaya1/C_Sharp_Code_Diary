...
namespace otopark_programı
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            aciklama.SetToolTip(button4,"Arama Yap");
            aciklama.SetToolTip(button5, "Kayıt Güncelle");
            aciklama.SetToolTip(button6, "Kayıt Sil");
            aciklama.SetToolTip(button7, "Resim Ekle");
            aciklama.SetToolTip(button1, "Kayıt Ekle");
            listele(); 
        }
